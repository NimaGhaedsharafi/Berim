...
class jDateTime
{
   ...
   /**
    ...
    public static function getdate($timestamp = null)
    {
        ...
        return [
            'seconds' => self::date('s', $timestamp),
            'minutes' => self::date('i', $timestamp),
            'hours'   => self::date('H', $timestamp),
            'mday'    => self::date('t', $timestamp),
            'wday'    => self::date('w', $timestamp),
            'mon'     => self::date('m', $timestamp),
            'year'    => self::date('Y', $timestamp),
            'yday'    => self::date('z', $timestamp),
            'weekday' => self::date('l', $timestamp),
            'month'   => self::date('F', $timestamp),
            '0'       => self::date('U', $timestamp)
        ];
    }
}